...
class I18nTranslation
{
    ...
    {
        $item = self::doSelectOne(
            array('where' => array('culture' => $this->getCulture(), 'source' => $this->getSource()))
        );
    ...
    public static function getTranslations($culture)
    {
        // TODO: Handle cache
        $entries = self::doSelect(array('where' => array('culture' => $culture)));

        $translations = array();
        foreach ($entries as $translation) {
            /** @var I18nTranslation $translation */
            $translations[$translation->getSource()] = $translation;
        }
