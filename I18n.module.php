...
class I18n extends CMSModule
{
  ...
  function CheckAccess()    {    return $this->CheckPermission('Manage I18n');    }
  ...
  {
    $module =& cms_utils::get_module('I18n');
    return $module->Translate($content, $elements);
  }
  ...
  public function Translate($content, $elements = array())
  {
    if($content != '')
    {
     ...
     {
        $translation = html_entity_decode($content); // Show the default language text if translation do not exists.
